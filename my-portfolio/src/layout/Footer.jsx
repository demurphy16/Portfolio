  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        ...
        <a rel="noreferrer" href="https://github.com/demurphy16" target="_blank" className="icon-anchor">
          <img className="footer-icon" alt="icon" src="https://www.flaticon.com/svg/static/icons/svg/1322/1322104.svg"/>
        </a>
        <a rel="noreferrer" href="https://www.linkedin.com/in/david-murphy-a46453181/" target="_blank"className="icon-anchor">
